            ...
            <Button 
              ...
              onClick={() => {
                razorpayService.initiatePayment({
                  ...
                  description: `Payment for ${record.group?.name || 'Group'} - Cycle ${record.cycle?.cycleNumber || ''}`,
                  type: 'payment',
  ...
  return (
    <DashboardLayout user={user} onLogout={logout}>
      <div className="payments-dashboard-container">
        ...
        {/* Success Alert */}
        {successMessage && (
          <Alert type="success" closable onClose={() => setSuccessMessage(null)}>
            {successMessage}
          </Alert>
        )}
                      ...
                      <Button
                        ...
                        onClick={() => {
                          razorpayService.initiatePayment({
                            ...
                            memberName: user?.name || 'Member',
                            description: `Payment for ${payment.group?.name || 'Group'} - Cycle ${payment.cycle?.cycleNumber || ''}`,
                            type: 'payment',
                            groupName: payment.group?.name || 'Group',
